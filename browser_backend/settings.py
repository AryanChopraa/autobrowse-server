"""
Django settings for browser_backend project.
...
ROOT_URLCONF = 'browser_backend.urls'

ALLOWED_HOSTS = getenv('DJANGO_ALLOWED_HOSTS',
   '127.0.0.1,localhost').split(',')

# CORS_ALLOWED_ORIGINS = getenv('FRONTEND_URL','http://localhost:3000,http://127.0.0.1:3000').split(",")
...
SITE_NAME = 'From BrowserFlow Team'
